...
const developers: Developer[] = [
  ...
  {
    name: 'Luilly Florez',
    role: 'Desarrollador de Adquisición de Datos',
    avatar: '/img/developers/luilly.jpeg',
    bio: 'Creador de los sistemas de extracción y recolección automatizada de datos. Sus scripts de web scraping son el motor que alimenta de contenido valioso a la plataforma.',
    social: { twitter: '#', linkedin: '#', github: '#' },
  },
  {
    name: 'Ricsabel Perez',
    role: 'Desarrolladora de la Biblioteca Digital',
    avatar: '/img/developers/ricsabel.jpeg',
    bio: 'Mente creativa detrás de la arquitectura y lógica de la Biblioteca. Su trabajo asegura una organización coherente y un acceso rápido a todos los recursos literarios.',
    social: { twitter: '#', linkedin: '#', github: '#' },
  },
  {
    name: 'Daniel Becerra',
  ...
  {
    name: 'Joel Blanco',
    role: 'Desarrollador Frontend y Diseño Adaptativo',
    avatar: '/img/developers/joel.jpeg',
    bio: 'Aseguró que la experiencia de usuario sea perfecta en cualquier dispositivo. Su enfoque en el diseño adaptativo fue clave para lograr una accesibilidad universal.',
    social: { twitter: '#', linkedin: '#', github: '#' },
  },
  {
    name: 'Javier Sayago',
    ...
    bio: 'Líder visionario que guió el proyecto desde su conceptualización hasta el lanzamiento. Su gestión estratégica fue el pilar para la cohesión del equipo y el éxito de la plataforma.',
    social: { twitter: '#', linkedin: '#', github: '#' },
    objectPosition: 'top',
  },
  {
    name: 'Vladimir Altuve',
    role: 'Analista en la Fiabilidad del Sitio',
    avatar: '/img/vladimir.jpg',
    bio: 'Guardián de la infraestructura y la estabilidad de la plataforma. Implementó los sistemas de despliegue y monitorización que garantizan la disponibilidad y rendimiento del sitio.',
    social: { twitter: '#', linkedin: '#', github: '#' },
  },
];
